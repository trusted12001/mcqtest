    ...
    <div class="authincation h-100">
        <div class="container h-100">
            ...
            <?php if(isset($institution_name) && ($institution_name['sch_status'] == 'Active')){ ?>
                <form method="post" action="<?php echo base_url();?>login/cbt_check_login">
                    <div class="mb-3">
                        <label class="mb-1"><strong>Enter PIN number to log in</strong></label>
                        <input type="text" name="pin_number" class="form-control" placeholder="example: N2E123N2" autofocus required>
                    </div>
                    <div class="row d-flex justify-content-between mt-4 mb-2">
                        <div class="mb-3">
                           <div class="form-check custom-checkbox ms-1">
                            <label class="form-check-label" for="basic_checkbox_1"><b>Note:</b> Personal Identification Numbers are case sensitive.</label>
                            </div>
                        </div>
