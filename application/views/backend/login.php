            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-6">
                  ...
                  <hr />
                    ...
                    <?php if(isset($institution_name) && ($institution_name['sch_status'] == 'Active')){ ?>
                        <h3 class="text-center mb-4">
                            LICENSED TO <?php echo strtoupper($institution_name['sch_name']); ?>
                        </h3>
                    <?php } else{ ?>
                        <h3 class="text-center mb-4" style="color:red">
                        License could not be authenticated!
                        </h3>
                    <?php } ?>
...
<?php if(isset($institution_name) && ($institution_name['sch_status'] == 'Active')){ ?>
    <form method="post" action="<?php echo base_url();?>login/check_login">
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="cbt" autofocus required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row d-flex justify-content-between mt-4 mb-2">
                        <div class="mb-3">
                           <div class="form-check custom-checkbox ms-1">
													...
													<label class="form-check-label" for="basic_checkbox_1"><b>Note:</b> Username and Password are case sensitive.</label>
												</div>
                                            </div>
                                    ...
                                    <div class="mt-3">
                                      <a href="<?php echo base_url();?>login/recovery">Recover Login Details</a>
