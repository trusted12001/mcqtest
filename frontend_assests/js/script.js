...
$(function(){
  ...
  $(".step_1").on('click', function(){
    ...
    $('.'+data).children(".opt_1").prop('checked', false);
    $(".placeholder"+data).prop('checked', false);

    $(this).addClass("active");
    $(this).children(".opt_1").prop('checked', true);
  });
...
// Storing selected options into and array
...
// $('.storeOpt').on("click",function(event){ 
// 	clickedButtonIds.push($(this).attr('data-id'));
//   alert(clickedButtonIds);
// }); 
